...
if (!defined('EASY_CONNECT_URL')) {
	define('EASY_CONNECT_URL', plugin_dir_url(dirname(__FILE__))); // This will return the URL up to the /plugins/ directory
}
...
require_once EASY_WHATSAPP_DIR . 'includes/ew-wa-chat-page.php';
